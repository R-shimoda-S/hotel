...
//入力値を保存する
$_SESSION["res"]["number"]=$su->sanitize2($_POST["number"]);
$_SESSION["res"]["start"]=$su->sanitize2($_POST["start"]);
$_SESSION["res"]["end"]=$su->sanitize2($_POST["end"]);
$_SESSION["res"]["single"]=$su->sanitize2($_POST["single"]);
$_SESSION["res"]["double"]=$su->sanitize2($_POST["double"]);
$_SESSION["res"]["quadruple"]=$su->sanitize2($_POST["quadruple"]);

$isNullorWhitespace=new IsNullorWhitespace();
$functionNumber=$isNullorWhitespace->is_nullorwhitespace($_POST["number"]);
$functionSingle=$isNullorWhitespace->is_nullorwhitespace($_POST["single"]);
$functionDouble=$isNullorWhitespace->is_nullorwhitespace($_POST["double"]);
$functionQuadruple=$isNullorWhitespace->is_nullorwhitespace($_POST["quadruple"]);
