...
<body>
    ...
    <div class="container form">
        <div class="row">
            ...
            <div class="mx-auto col-8 col-sm-6">
                <input type="text" class="number" id="number" name="number" 
                value="<?php if (!empty($_SESSION["change"]["number"])) {
    echo $_SESSION["change"]["number"];
} else {
    echo $session[0]["number_of_people"];
}?>" size="20">
            </div>
        </div>
    </div>
    ...
    <div class="container form">
        <div class="row">
            ...
            <div class="mx-auto col-8 col-sm-6">
            <input type="date" class="start" id="start" name="start"  
            value="<?php if (!empty($_SESSION["change"]["start"])) {
    echo $_SESSION["change"]["start"];
} else {
    echo $session[0]["lodging_start_day"];
}?>" size="20">
            </div>
        </div>
    </div>
    ...
    <div class="container form">
        <div class="row">
            ...
            <div class="mx-auto col-8 col-sm-6">
            <input type="date" class="end" id="end" name="end" 
            value="<?php if (!empty($_SESSION["change"]["end"])) {
    echo $_SESSION["change"]["end"];
} else {
    echo $session[0]["lodging_finish_day"];
}?>" size="20">
            </div>
        </div>
    </div>
    ...
    <div class="calander">
      ...
      <div class="navi">
              <div class="row">
                  <div class="col-4 text-right">
                      <p><a href="form.php/?month=<?= $month - 1 ?>">&lt;&lt;前の月</a></p>
                  </div>
                  <div class="col-4 text-center">
                  <p><a href="form.php/">今月</a></p>
                  </div>
                  <div class="col-4 text-left">
                  <p><a href="form.php/?month=<?= $month + 1 ?>">次の月&gt;&gt;</a></p>
                  </div>
              </div>
          </div>
    ...
    <div class="container form">
        <div class="row">
            ...
            <div class=" mx-auto col-8 col-sm-6">
                <div class="room">シングル <input type="text" class="single" id="single" name="single" 
                value="<?php if (!empty($_SESSION["change"]["single"])) {
                    echo $_SESSION["change"]["single"];
                } else {
                    echo $session_room[0];
                }?>"size="10" placeholder="半角数字">部屋<br/></div>
                <div class="room">ダブル　 <input type="text" class="double" id="double" name="double"
                value="<?php if (!empty($_SESSION["change"]["double"])) {
                    echo $_SESSION["change"]["double"];
                } else {
                    echo $session_room[1];
                }?>" size="10" placeholder="半角数字">部屋<br/></div>
                <div class="room">４人部屋 <input type="text" class="quadruple" id="quadruple" name="quadruple"
                value="<?php if (!empty($_SESSION["change"]["quadruple"])) {
                    echo $_SESSION["change"]["quadruple"];
                } else {
                    echo $session_room[2];
                }?>" size="10" placeholder="半角数字">部屋</div>
            </div>
        </div>
    </div>
